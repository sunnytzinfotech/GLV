      ...
      <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="padding-bottom:20px;">
            Hallo {{$cname}}, <br>
            <br>
            Sie haben es fast geschafft, Bitte bestätigen Sie Ihre E-Mail,. <br>
            <br>
      ...
      <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td class="left" style="padding-bottom:20px; text-align:left;">
            Diese Bestätigung erfolgt zu Ihrem Schulz Damit wollen wir sicherstellen, dass Sie sich persönlich <br>registriert haben und Ihre E-Mail-Adresse nicht unerlaubt von Dritten nenn. wuMe.
          </td>
        </tr>
      </table>
      <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td class="left" style="padding-bottom:20px; text-align:left;">
            Wenn Sie diese E-Mail irrtümlich erhalten haben, löschen Sie diese einfach.<br>Wenn Sie den Bestätigungslink oben nicht anklicken, wiM Ihre E-Mail-Adresse nicht bestätigt und <br>der Registrierungsprozess abgebrochen.
          </td>
        </tr>
      </table>
      ...
      <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td class="left" style="padding-bottom:10px;text-align:left;">
            Mit freundlichen GrüBen aus Hil
          </td>
        </tr>
        <tr>
