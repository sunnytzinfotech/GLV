                ...
                <div class="ibox-content">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Left Section Description First</td>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <td>Left Section Description Second</td>
                                <td>
                                    <?php
                                        if(isset($content_data['home_section_2_text']))
                                        {
                                            $text = strip_tags($content_data['home_section_2_text']);
                                            $str = (strlen($text) > 100) ?substr($text,0,100).'...' :  $text;
                                            echo $str;
                                        }
                                    ?>
                ...
                <div class="modal-body p-lg">
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            ...
                            <div class="box m-b-md">
                                <textarea  name="description" class="summernote" required>@if(isset($content_data['home_section_2_text'])) {{$content_data['home_section_2_text']}} @endif</textarea>

                                <input name="_token" type="hidden" value="{{csrf_token()}}" />
                                <input type="hidden" name="action" value="home_section_2_text">
                                <input type="hidden" name="page_name" value="home">
                            </div>
                        </div>
                    </div>
